...
<div class="card mb-3">
    ...
    <div style="max-height: 300px;  overflow:hidden">
        <img     src="{{ asset('storage/'. $beranda[0]->image) }}"
        alt="{{ $beranda[0]->category->name }} " class="mx-auto d-block" style="max-height:300px;">
    </div>
    @else
            ...
            <div class="card" style="height:18cm">
                <div class="position-absolute px-3 py-2" style="background-color:rgba(0, 0, 0, 0.5)">
                    ...
                    <a href="/beranda/{{ $beranda->slug }}">
                        ...
                        @else
                            <img src="https://source.unsplash.com/500x450?{{ $beranda->category->name }}"
                            class="card-img-top" alt="{{ $beranda->category->name }}"></a>
                        @endif
