...
unset($__errorArgs, $__bag); ?>" 
                id="name" placeholder="Name" autofocus required value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                id="username" placeholder="Usename" required value="<?php echo e(old('username')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                id="email" placeholder="name@example.co." required value="<?php echo e(old('email')); ?>">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Akatara-Outdoor\resources\views/register/index.blade.php ENDPATH**/ ?>