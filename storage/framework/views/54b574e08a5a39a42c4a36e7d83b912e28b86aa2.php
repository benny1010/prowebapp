...
<div class="card mb-3">
    ...
    <div style="max-height: 500px; overflow:hidden">
        ...
        alt="<?php echo e($beranda[0]->category->name); ?>" class="img-fluid">
    </div> 
    <?php else: ?>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card" style="height:17cm">
    ...
    <small class="d-block mt-4 text-muted text-center">&copy; 2021 | Akatara Outdoor</small>




<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Akatara-Outdoor\resources\views/beranda.blade.php ENDPATH**/ ?>